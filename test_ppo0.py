...
from tf_agents.environments import suite_gym  # suite_mujoco
  ...
  with tf.compat.v2.summary.record_if(
    ...
    while environment_steps_metric.result() < num_environment_steps:
      ...
      if global_step_val % eval_interval == 0:
        ...
        avg_return = compute_avg_return(eval_tf_env, tf_agent.policy)
        logging.info('step = %d, avg_return = %f', global_step_val, avg_return)
