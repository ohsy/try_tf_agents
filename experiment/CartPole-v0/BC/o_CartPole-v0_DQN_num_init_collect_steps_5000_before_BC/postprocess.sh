...
python3 get_avg_returns.py 5 o_CartPole-v0_DQN_num_init_collect_steps_5000
python3 plot_csv.py o_CartPole-v0_DQN_num_init_collect_steps_5000
mkdir o_CartPole-v0_DQN_num_init_collect_steps_5000
mv o_CartPole-v0_DQN_num_init_collect_steps_5000.* o_CartPole-v0_DQN_num_init_collect_steps_5000
mv o_CartPole-v0_DQN_num_init_collect_steps_5000_* o_CartPole-v0_DQN_num_init_collect_steps_5000
cp config.json playbatch*.sh postprocess.sh o_CartPole-v0_DQN_num_init_collect_steps_5000
