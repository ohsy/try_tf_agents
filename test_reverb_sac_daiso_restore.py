    ...
    def __init__(self, *args, **kwargs):
        super(NormalizedActorPolicy, self).__init__(
            *args,
            ...
            observation_normalizer=tensor_normalizer.StreamingTensorNormalizer(observation_spec),
            **kwargs
        )
...
reverb_checkpoint_path = "/tmp/tmp6j63a_f_"  # parent directory of the returned path
