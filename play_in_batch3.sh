...
# python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 2000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_2000_3 ; \
# python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 3000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_3000_3 ; \
# python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 4000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_4000_3 ; \
...
python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 6000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_6000_3 ; \
python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 7000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_7000_3 ; \
python3 play_mini.py -e Reacher-v2_discrete -a CDQN_multiagent -n 3 -i 8000 &> o_Reacher-v2_discrete_CDQN_multiagent_num_actions_3_num_init_collect_steps_8000_3 ; \
